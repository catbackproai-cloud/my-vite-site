 ...
 * Only two fields: 1) Screenshot, 2) Strategy notes.
 * The AI / backend should infer market, direction, timeframe, etc. from the image.
 *
...
function FeedbackCard({ data }) {
  // Expected shape from n8n response, minimal guaranteed fields:
